...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <?php echo "<h4><a href=index.php?action=list&file=><img src='" . ASSETS_PATH . "/arrowup.png' height=25></a><a href=$_SERVER[PHP_SELF]?action=list&file=$rootdir[dirname]/>$rootdir[dirname]</a>/<b>$filenameX</b><br></h4>"; ?>
        </div>
    </div>
</div>
            ...
            <div id="tab-source">
                ...
                <table class="TFtable" ;>
                    ...
                    foreach ($contents as $n) {
                        ...
                        echo "<tr>";
                        if (isset($k)) {
                            echo "<th height='10' style='text-align:right'>$k</th><td width='20'></td><td>$v</td>";
                        } else {
                            echo "$k";
                        }
                        echo "</tr>";
